$(document).ready(function() {
    ...
    var updateGlobalExample = function() {
        var content = "$.PostItAll.changeFeatures({\n";
    ...
    $('#idGetCreated').click(function(e) {
        if(idNewNote != null) {
            $('#idDivOptions').text($(idNewNote).postitall('options'));
